    ...
    <div className="relative bg-gray-100">
      <div className="container mx-auto px-4 py-12 md:px-6 lg:px-20 lg:py-28 flex flex-col lg:flex-row gap-8 items-center justify-between">
        ...
        <motion.div
          ...
          className="flex flex-col gap-6 text-black-500 text-center lg:text-left lg:w-1/2"
        >
          ...
          <p className="text-base sm:text-lg md:text-xl opacity-80">
            Join a global network of thriving brands that rely on
            CreateMyWebsite for seamless sales, payments, and operations.
          </p>
          ...
          <div className="mt-4 flex justify-center gap-4 lg:justify-start w-full max-w-sm md:max-w-lg">
            <div className="relative w-full">
              <input
                ...
                className="w-full text-black-500 py-2 md:py-3 pl-10 pr-4 rounded-lg border-2 border-black-500 focus:outline-none focus:ring-2 focus:ring-black-400 text-sm md:text-lg"
              />
              <svg
                className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-black-500"
        ...
        >
          ...
          >
            ...
            <p className="mt-2 text-black-500 text-xs font-medium">
              {searchQuery
                ? `Searching for: ${searchQuery}`
                : "Enter a domain and host to get started."}
            </p>
          </motion.div>
          ...
          >
            <h5 className="text-xs font-medium text-black-500">
              TOTAL REVENUE
            </h5>
            <div className="flex items-center justify-between mt-2">
              <h4
                ref={priceRef}
                className="text-xl md:text-2xl font-bold text-black-500"
              >
                $218
              </h4>
              <img
            ...
            <div className="mt-2 border-t pt-2 text-xs text-gray-500">
              ...
              <p className="text-black-500">See Full Report &gt;</p>
            </div>
          </motion.div>
        </motion.div>
      </div>
