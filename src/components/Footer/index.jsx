    ...
    <div className="bg-gray-800 text-white">
        ...
        <div className="container mx-auto max-w-[1344px] px-5 py-10 text-center">
          ...
          >
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Let us assist you with everything you need to grow your business.
              Reach out, and we’ll make sure you’re set up for success.
            </p>
            {isHomePage && (
              <MainButton style="bg-gray-600 hover:bg-blue-500 transition-all  px-8 py-2 rounded">
      ...
      {isHomePage && (
        <div className="container mx-auto max-w-[1344px] px-5 py-10">
          ...
          >
            <h2 className="text-3xl font-semibold mb-5 w-1/2">
              Frequently Asked Questions
            </h2>
          </motion.div>

          <div className="flex space-x-4">
            {/* FAQ Section - occupies 50% */}
            ...
            {/* Form Section - occupies 50% */}
            <div className="w-1/2">
              {/* Form goes here */}
              <form className="space-y-4 bg-gray-100 px-6 py-5 mx-5 my-20 rounded-lg shadow-md">
                <div>
                  <label className="block text-gray-700">Name</label>
                  <input
                    type="text"
                    className="w-full p-2 mt-2 border rounded-md focus:outline-none focus:ring focus:ring-indigo-300 text-black-100"
                  />
                </div>
                <div>
                ...
                <button
                  type="submit"
                  className="w-full bg-black-500 text-white p-2 rounded-md hover:bg-black-500"
                >
                  Submit
                </button>
              </form>
      ...
      <footer className="container mx-auto max-w-[1344px] px-5 py-16 grid grid-cols-1 gap-12 md:grid-cols-3 text-center md:text-left">
        <div className="space-y-3">
          ...
          <p className="text-gray-400">
            We are a company dedicated to helping you expand your online
            presence and achieve business goals with ease.
          </p>
        </div>
