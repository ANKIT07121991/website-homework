...
export function PrimaryCard({ primaryContainer, miniModal, fakeProfiles }) {
  return (
    <div className="w-11/12 max-w-[400px] p-6 relative z-10 rounded-xl shadow-lg bg-black-100 sm:p-10 md:p-6 lg:p-12">
      <motion.div
        initial="hidden"
        whileInView="visible"
      ...
      >
        ...
        <button className="py-3 bg-black-500 text-white font-semibold rounded-lg w-full text-sm hover:bg-black-500 sm:py-4 lg:py-5 lg:text-lg">
          Add New Profile
        </button>
      </motion.div>
      ...
      >
        ...
        <h4 className="font-bold text-xl text-black-500 sm:text-2xl lg:text-3xl">
          $1,200.50
        </h4>
        <button className="bg-black-500 text-white text-sm py-3 rounded-lg w-full hover:bg-black-500 sm:py-4 lg:text-lg">
          Quick Pay Now
        </button>
      </motion.div>
    </div>
    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <img className="w-5 h-5 object-cover" src="/dot-icon.svg" alt="Dot" />
        </div>
