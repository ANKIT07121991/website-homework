    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-6">
      <div className="grid gap-8 md:grid-cols-3 w-full max-w-6xl">
        ...
        <PricingCard
          ...
          buttonColor="bg-black-100 text-white"
        />
        ...
        <PricingCard
          ...
          buttonColor="border border-black-500"
        />
      </div>
    </div>
  );
...
const PricingCard = ({ title, price, features, buttonLabel, buttonColor }) => {
  return (
    <motion.div
      ...
      className="bg-white p-8 mt-[6rem] rounded-lg shadow-lg text-black-500 w-full max-w-md transform transition duration-300 hover:shadow-2xl"
    >
      <h3 className="text-xl font-semibold text-black-500 mb-2">{title}</h3>
